...
//UPCASTING
//Conversão de subclasse para super classe
...
// BusinessAccount acc5 = (BusinessAccount) acc3; -- Essa linha dá erro pois SavingAccount não é do tipo BunissesAccount.
...
Account acc2 = new SavingsAccount(1002, "Anna", 500.0, 0.001);
